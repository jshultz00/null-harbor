...
"Username,Password`njsmith,Password1!`nmjones,Password1!" | Out-File "C:\Shares\HR\employee-credentials-backup.csv"
"# Admin credentials`n# DC01: Administrator / Password1!" | Out-File "C:\Shares\IT\admin-notes.txt"
