...
const NETWORK_MAP_DATA = {
  "_meta": {
    ...
    "host_requirements": {
      ...
      "min_ram_core_scenario": "~18 GB (scenario + fw-dmz + fw-core + dc01 + wks-win10)"
    }
  },
  "networks": {
    "control": {
      "subnet": "10.0.0.0/24",
      "docker_name": "control",
      "description": "Saffron OOB management — every machine has an interface here"
    },
    "external": {
      "subnet": "9.53.99.0/24",
  ...
  "machines": {
    "scenario": {
      ...
      "interfaces": [
        {"network": "control",  "ip": "10.0.0.1/24"},
        {"network": "external", "ip": "9.53.99.1/24"}
      ]
    },
    "fw-dmz": {
      "OS": "Linux (nftables)",
      ...
      "interfaces": [
        {"network": "control",  "ip": "10.0.0.10/24"},
        {"network": "external", "ip": "9.53.99.2/24"},
    ...
    "fw-core": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.11/24"},
    ...
    "wireguard": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.20/24"},
    ...
    "wazuh.manager": {
      ...
      "Memory (GB)": "2",
      "HDD Size (GB)": "20",
      "description": "Wazuh manager: agent enrollment (PSK), OSSEC rules, and alert processing. Agents on Linux hosts reach this via the control network (10.0.0.5). Run 'make build' to generate TLS certs before first 'make up'.",
      "deploy": {
        "type": "linux-container",
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.5/24"},
    ...
    "wazuh.indexer": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.6/24"},
    ...
    "wazuh.dashboard": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.7/24"},
    ...
    "rsyslog": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.8/24"},
    ...
    "web-lin": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.40/24"},
    ...
    "web-win": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.42/24"},
    ...
    "dc01": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.70/24"},
    ...
    "exchange": {
      ...
      "Memory (GB)": "6",
      "HDD Size (GB)": "60",
      "description": "Microsoft Exchange mail server for secure.net. Used in phishing, email exfiltration, and credential harvesting scenarios. Fully functional mail flow (60-90 min first-boot).",
      "deploy": {
        "type": "windows-container",
        "image": "ghcr.io/dockur/windows",
        "mem_limit": "6g",
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.72/24"},
    ...
    "fileserver": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.74/24"},
    ...
    "db01": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.30/24"},
    ...
    "wks-linux": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.100/24"},
    ...
    "wks-win10": {
      ...
      "Memory (GB)": "4",
      "HDD Size (GB)": "60",
      "description": "Windows 10 workstation joined to secure.net. Standard corporate endpoint. Users: SECURE\\jsmith, SECURE\\mjones. Primary phishing target for payload delivery, credential harvesting, and lateral movement.",
      "deploy": {
        "type": "windows-container",
        "image": "ghcr.io/dockur/windows",
        "mem_limit": "4g",
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.101/24"},
    ...
    "wks-win11": {
      ...
      "interfaces": [
        {"network": "control", "ip": "10.0.0.102/24"},
        {"network": "users",   "ip": "10.30.30.30/24"}
      ]
    }
  },
  "layout": {
  ...
  "profiles": {
    ...
    "minimal": {
      "description": "Core scenario — AD domain, one Windows workstation, scenario engine. ~18 GB RAM.",
      "command": "make up-minimal",
      "services": ["scenario", "fw-dmz", "fw-core", "dc01", "wks-win10"],
      "expansion_order": ["wks-win11", "fileserver", "exchange", "web-lin", "web-win", "wazuh.manager", "wazuh.indexer", "wazuh.dashboard", "rsyslog", "wireguard", "db01"]
    },
    "full": {
      "description": "All services. Requires ~50 GB RAM.",
      "command": "make up",
      "services": ["all"]
    }
  }
